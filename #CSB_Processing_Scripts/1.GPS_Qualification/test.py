...
if check_for_args():
	outputPos = sys.argv[1].split('/')[-1]
	outputPos = outputPos.split('.')[0]
	outputPos += ".pos"
	apply_nrcan_ppp(sys.argv[1], sys.argv[2])
	qualify_ppp_output(outputPos, sys.argv[2])
else:
	print "No arguments provided."
	print " "
	print "------- Usages -------"
	print "python gps_qualification.py 'RENEX_file' 'work_directory'"
	print " "
	print "And also, for it to work, python need to run this file"
	print "within the directory #CSB_Processing_Scripts/GPS_Qualification"
'''
...
qualify_ppp_output("D:/Dropbox/Running/ProjectResearch/#Software/Sample_Data_CSB/HydroBall_GjoaHaven/data/GPS/2018_08_02/rinex_RTKLIB/test_srt/HydroBall_20180802.pos", "D:/Dropbox/Running/ProjectResearch/#Software/Sample_Data_CSB/HydroBall_GjoaHaven/data/GPS/2018_08_02/rinex_RTKLIB/test_srt/")